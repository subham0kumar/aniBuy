    ...
    <div className="md:hidden">
      <div className="flex font-rubik my-2">
        ...
        <div className="ml-2 flex flex-col">
          <span className="text-[1rem] hidden md:block">{title.substring(0, 25)}...</span>
          <span className="text-[1rem] md:hidden">{title}</span>
      ...
      <div className="w-fit flex">
        ...
        <span className="w-fit flex ml-2 px-16 py-2 bg-action rounded-md text-second shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-second hover:text-action md:active:scale-95 md:hover:scale-105 cursor-pointer">
