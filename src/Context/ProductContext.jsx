...
const ProductContext = ({ children }) => {
  ...
  const animeList = ['Naruto', 'One Peice', "Dragonball", 'Bleach']
  const categoryList = ['Figurine','Lamps','Posters', 'Stickers', 'Tees', 'Winter Wear']
  const navbarData = [
    {
  ...
  return <product.Provider value={{ products, animeList, categoryList, navbarData}}>{children}</product.Provider>;
};
